...
const InnovationManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(error || "Failed to save innovation");
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-white rounded-lg shadow">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search innovations by title..."
            value={searchTerm}
          ...
          filteredInnovations.map((innovation) => (
            <div key={innovation._id} className="overflow-hidden bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                ...
                <h3 className="mb-2 text-lg font-medium text-gray-900 line-clamp-2">{innovation.title}</h3>
                <div className="flex items-center justify-between mt-3">
                  <div className="text-xs text-gray-500">
                    Created by: {innovation.createdBy?.name || "Admin"}
                  </div>
