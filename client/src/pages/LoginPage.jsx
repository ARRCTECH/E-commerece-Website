            ...
            <div className="p-7 sm:p-8 pt-2">
              ...
              <div className="flex p-1 mb-5 rounded-xl bg-white/5 backdrop-blur-sm">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${activeTab === "email"
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${activeTab === "phone"
                      ? "bg-gradient-to-r from-red-500 to-pink-500 text-white shadow-lg"
                      : "text-white/60 hover:text-white hover:bg-white/10"
                    }`}
                >
              ...
              <AnimatePresence>
                {(localError || success) && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -8 }}
                    className={`mb-4 flex items-start gap-2 rounded-xl backdrop-blur-sm border px-3 py-2.5 text-sm ${localError
