      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1 space-y-6">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            At <span className="font-semibold text-red-600">Factory Sale</span>, we don’t just create T-shirts—we create a vibe.
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Every Factory Sale T-shirt is made with <span className="font-semibold">premium, breathable fabrics</span>
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            <span className="font-semibold text-red-600"> Factory Sale </span> is designed for those who live life with intention, passion,
            and a little bit of bliss.
          </p>
          <p className="text-gray-800 font-medium text-xl">
            ✨ Wear what feels right. Because when you wear Factory Sale,
